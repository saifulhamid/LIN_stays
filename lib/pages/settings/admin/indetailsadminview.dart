...
class InDetailAdminView extends StatefulWidget {
  int index;
  InDetailAdminView(this.index, {super.key});

  @override
  State<InDetailAdminView> createState() => _InDetailState();
}

class _InDetailState extends State<InDetailAdminView> {
                ...
                ElevatedButton(
                    ...
                    onPressed: () {
                      Navigator.push(
                          context,
                          MaterialPageRoute(
                              builder: (context) => ConfirmationPageAdminView(
                                    widget.index,
                                  )));
                    },
                    child: const Text(
